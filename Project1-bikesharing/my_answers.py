...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        ##NOTA: en el excel unit_tests_model.xlsx mostramos el cálculo de las deltas en función de la derivada parcial
        # del error respecto a cada uno de los parámetros, justificando las operaciones realizadas en este apartado
        ...
        output_error_term = -1.0*error*hidden_outputs # Para que esto sea así la función de error considerada tiene que
        # ser E(y_hat) = (1/2)*(y-y_hat)**2, de modo que la derivada respecto de y_hat sea -(y-yhat). Si se considerará
